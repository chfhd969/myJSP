	...
	<section>
		<div id="board">                
			...
			<div id="qustionMenu" class="fl cl">
				<h2>자주 묻는 질문</h2>	
				<div id="qustionMenuTitle">Q&amp;A 게시판</div>
				<div id="serchBar" class="fr">
					<ul>
						<li>
							<button class="searchButton" tabindex="183">검색</button>
						</li>
						<li>
							<input name="serch" type="text" tabindex="184"/>
						</li>
						<li class="serchBarQnA">Q&amp;A</li>
					</ul>
				</div><!-- id="serchBar" -->
				<div id="serchBox" class="fr">
					<ul class="cf">
						<li><a href="">Top10</a></li>
						<li><a href="">진료안내</a></li>
						<li><a href="">진단서 발급</a></li>
						<li><a href="">자가진단서비스</a></li>
						<li><a href="">진료예약</a></li>
					</ul>
				</div>
				<div class="totalPage">
					<ul class="cf">
						<li>Total 38건 1페이지</li>
					</ul>
				</div>
				<div id="qustionList" class="cf">
					<h3>Q&amp;A 리스트</h3>
					<ul class="topTitle cf">
						<li>
							<div>
								<ul class="top cf">
									<li class="num">번호</li>
									<li class="topClass">분류</li>
							...
							<div>
								<ul class="topTitleMenu cf">
									<li class="num">${articleNum.count}</li>
									<li class="topClass">${article.id}</li>
				...
				<div id="page" class="cf">
					<div>
						<ul>
							<li class="prev"><a href="#" tabindex="201">이전</a></li>
							<li><a href="#" tabindex="202">1</a></li>
							<li class="active"><a href="#" tabindex="203">2</a></li>
							<li><a href="#" tabindex="204">3</a></li>
							<li><a href="#" tabindex="205">4</a></li>
							<li><a href="#" tabindex="206">5</a></li>
							<li class="next"><a href="#" tabindex="207">다음</a></li>
						</ul>
						<li	class="pageWrite">
							<a href="#" class="write" tabindex="208">글쓰기</a>
						</li>
					</div>
				</div>			
			</div><!-- id="qustionMenu" -->
