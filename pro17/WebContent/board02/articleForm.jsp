...
<meta charset="UTF-8">
<title>글쓰기창</title>
<script src="http://code.jquert.com/jquert-latest.min.js"></script>
<script type="text/javascript">
	//제이쿼리를 이용해서 이미지 파일 첨부시 미리보기 기능 구현
...
<form name="articleForm" method="post" action="${contextPath}/board/addArticle.do" enctype="multipart/form-data">
	<table border=0 align="center">
		...
		<tr>
			...
			<td colspan="2"><textarea type="content" rows="10" cols="65" maxlength="4000"></textarea></td>
		</tr>
		<tr>
